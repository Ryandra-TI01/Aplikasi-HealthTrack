...
>
    <div class="max-w-4xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
        ...
        <div class="text-center lg:text-left -top-10" data-aos="fade-right">
            <p class="text-gray-500 mb-2 text-xl" data-aos="fade-up" data-aos-delay="100">
                Welcome to HealthTrack!
            </p>
            <h1 class="text-3xl md:text-4xl font-bold text-primary leading-tight mb-4" data-aos="fade-up" data-aos-delay="200">
                Reliable Health Tracking <br> for Long–Term Care
            </h1>
            <p class="text-gray-600 mb-6 max-w-md mx-auto lg:mx-0" data-aos="fade-up" data-aos-delay="300">
            ...
            <x-button class="transition-all duration-300 hover:scale-105 hover:shadow-lg">
